...
# 官方定价离线种子包与官方快照元数据种子包、官方 HTML 快照证据链目录
seed_file = project_dir / 'data' / 'official_prices_seed.json'
if seed_file.exists():
    datas.append(('data/official_prices_seed.json', 'data'))

snapshots_seed_file = project_dir / 'data' / 'official_snapshots_seed.json'
if snapshots_seed_file.exists():
    datas.append(('data/official_snapshots_seed.json', 'data'))
