            ...
            for p, site, model in rows:
                ...
                items.append(
                    ComparisonItemSchema(
                        ...
                        official_model_id=getattr(p, "official_model_id", None),
                        official_model_name=getattr(p, "official_model_name", "") or "",
                        official_input_discount=getattr(p, "official_input_discount", None),
                        official_output_discount=getattr(p, "official_output_discount", None),
                        official_composite_discount=getattr(p, "official_composite_discount", None),
