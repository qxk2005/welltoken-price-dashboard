    ...
    async with AsyncSessionLocal() as session:
        ...
        for p in pricings:
            ...
            result.append({
                ...
                "official_model_id": p.official_model_id,
                "official_model_name": p.official_model_name,
                "official_input_discount": p.official_input_discount,
                "official_output_discount": p.official_output_discount,
                "official_composite_discount": p.official_composite_discount,
